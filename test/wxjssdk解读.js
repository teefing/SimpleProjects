!(function (e, n) {
  ...
  if (!window.jWeixin) {
    var n,
      ...
      u = -1 != ua.indexOf("wxdebugger"),
      // 在微信内部
      inWx = -1 != ua.indexOf("micromessenger"),
      // 是安卓
    ...
    var I = false,
      ...
      w = {
              ...
              M(
                ...
                (function () {
                  (S._complete = function (e) {
                    (g.preVerifyEndTime = now()), (y.state = 1), (y.data = e);
                  }),
        ...
        ready: function (e) {
          0 != y.state ? e() : (S._completes.push(e), !inWx && v.debug && e());
        },
        error: function (e) {
          wxVersion < "6.0.2" || (-1 == y.state ? e(y.data) : (S._fail = e));
        },
        ...
        previewImage: function (e) {
          M(config.previewImage, { current: e.current, urls: e.urls }, e);
        },
        ...
        openProductSpecificView: function (e) {
          M(
            config.openProductSpecificView,
            {
              pid: e.productId,
        ...
        openCard: function (e) {
          ...
          M(config.openCard, { card_list: i }, e);
        },
        consumeAndShareCard: function (e) {
          M(
            config.consumeAndShareCard,
        ...
        startSearchBeacons: function (e) {
          M(config.startSearchBeacons, { ticket: e.ticket }, e);
        },
        ...
        miniProgram: {
          ...
          getEnv: function (e) {
            O(function () {
              e({ miniprogram: "miniprogram" === window.__wxjs_environment });
            });
          },
        },
      },
